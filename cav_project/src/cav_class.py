...
class CAV:
    def __init__(self, ID, enter = 0):
        ...
        self.all_pts = [
            self.pt_a, self.pt_b, self.pt_c, self.pt_d, self.pt_e, self.pt_f,
            self.pt_g, self.pt_h, self.pt_i, self.pt_j, self.pt_j1, self.pt_k,
            self.pt_l, self.pt_m, self.pt_n, self.pt_o, self.pt_p, self.pt_q,
            self.pt_r, self.pt_s, self.pt_t, self.pt_u
        ]
    ...
    def regenerate_map(self, starting_pt=0, first_time=False):
        if first_time == True:
            ...
            self.collision_pts = self.enter_path["collision_pts"]
